        ...
        .then(function (data) {
          ...
          fetch(additionalData).then(function (response) {
            response.json().then(function (data) {
              ...
              //   var flagGreenEl = document.getElementById("uvi").style.color = "green";
              //   var flagOrangeEl = document.getElementById("uvi").style.color = "orange";
              //   var flagRedEl = document.getElementById("uvi").style.color = "red";

              if (data.current.uvi < 2) {
                uviEl.textContent =
                  "UV Index: " + data.current.uvi + " Favorable";
                // Display color coded flag of UV Index to indicate favorable conditions
                //uviEl.appendChild(flagGreenEl);
              } else if (data.current.uvi > 2 && uvi < 5) {
                uviEl.textContent =
                  "UV Index: " + data.current.uvi + " Moderate";
                // Display color coded flag of UV Index to indicate moderate conditions
                //  uviEl.appendChild(flagOrangeEl);
          ...
          fetch(forecast).then(function (response) {
            response.json().then(function (data) {
              ...
              tempDay5El.textContent =
                "Temp: " + data.daily[5].temp.day + "° F";
